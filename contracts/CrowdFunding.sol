...
contract CrowdFunding {
    ...
    function createCampaign( address _owner , string memory _title , string memory _desc ,
    uint256 _target , uint256 _deadline , string memory _image) public returns (uint256) {
        ...
        require(campaign.deadline < block.timestamp , "The deadline date should be a date in the future");
